...
window.onload = function() {
	...
	chat_id = document.getElementById('chat_id').value; //클라이언트 아이디
	...
	if (content == '') {
		...
		if (content.match("/")) {
			...
			*/
			...
			//일반적인 대화내용은 모든 클라이언트에게 디스플레이 되므로 대화창에 즉시 출력한다.
			messageWindow.innerHTML += msg;
			messageWindow.scrollTop = messageWindow.scrollHeight;
		}
	}
